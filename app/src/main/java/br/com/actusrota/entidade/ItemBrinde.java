...
public class ItemBrinde implements ItemManter {
	/**
	 * 
	 */
	...
	public ItemBrinde(ItemListView item) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ItemBrinde other = (ItemBrinde) obj;
		if (produto == null) {
	...
	public String toString() {
		...
		sb.append(id);
		sb.append(" ven:");
		sb.append(venda.getId());
		sb.append(" vig:");
		sb.append(viagem.getId());		
		return sb.toString();
	}
