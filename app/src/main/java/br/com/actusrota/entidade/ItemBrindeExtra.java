...
public class ItemBrindeExtra implements ItemManter {
	/**
	 * 
	 */
	...
	public ItemBrindeExtra() {
		// TODO Auto-generated constructor stub
	}
	
	public ItemBrindeExtra(ItemListView item) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ItemBrindeExtra other = (ItemBrindeExtra) obj;
		if (produto == null) {
