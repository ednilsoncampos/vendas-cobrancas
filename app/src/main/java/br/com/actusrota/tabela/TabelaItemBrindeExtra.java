...
public class TabelaItemBrindeExtra extends TabelaItem {
	public static final String TABELA_ITEM_BRINDE_EXTRA = "item_brinde_extra";
	public static final String FK_VIAGEM = "fk_viagem";

	public static final String[] COLUNAS_ITEM_BRINDE_EXTRA = { ID, VALOR_UNITARIO,
			TOTAL_UNITARIO, QUANTIDADE, FK_PRODUTO, FK_VENDA, FK_VIAGEM, ID_WEB };
	
	public static final String CREATE_TABLE_ITEM_BRINDE_EXTRA;
	static {
		StringBuilder sql = new StringBuilder(" CREATE TABLE ");
		sql.append(TABELA_ITEM_BRINDE_EXTRA);
		...
		CREATE_TABLE_ITEM_BRINDE_EXTRA = sql.toString();
	}
}
