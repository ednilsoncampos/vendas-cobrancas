...
public class TabelaItemDevolucao extends TabelaItem {
	
	public static final String TABELA_ITEM_DEVOLUCAO = "item_devolucao";
	public static final String FK_VIAGEM = "fk_viagem";

	public static final String[] COLUNAS_ITEM_DEV = { ID, VALOR_UNITARIO,
			TOTAL_UNITARIO, QUANTIDADE, FK_PRODUTO, FK_VENDA, FK_VIAGEM, ID_WEB };
	
	public static final String CREATE_TABLE_ITEM_DEV;
	static {
		StringBuilder sql = new StringBuilder(" CREATE TABLE ");
		sql.append(TABELA_ITEM_DEVOLUCAO);
		...
		CREATE_TABLE_ITEM_DEV = sql.toString();
	}
}
